							...
							<div class="col-lg-6">
								<div class="d-flex flex-column h-100">
									...
									<h5>
													...
													사계절 생활하기 좋은 지역. <br>
													엑스포가 개최된 이후 관광객 수가 크게 증가하였다.<br>
													다른 지역에 비해 여가서비스업 분야에서 소비액이 많은 편이다.<br>
													바다 경관을 중심으로 관광지와 맛집이 다수 분포되어 있으며,
													특히 밤바다를 걷고 있을때 느껴지는 파도소리와 야경은 새로운 세계에 온듯한 느낌을 준다.
					...
					<div
						...
						<div
							...
							<h5 style = "color :white;">1. 편향된 관광객 문제 해결<br>
							 여름철 및 특정지역에 집중되어 있는 방문객의 분산을 위해 여러 계절에 맞는 다양한 관광 프로그램을 마련하고,
							 주로 인기 있는 관광지외에도 조용한 곳을 소개하여 분산을 유도하기.<br>

							<!-- 2. 대중교통이 발달하지 않아 교통체증이 발생할 수 있기 때문에 대중교통 시스템 개선을 추친하고 관광객들에게 이용방법을 안내하는 노력이 필요합니다. --><br>
							
							2. 인프라 확충<br>
							레저 시설이나 호텔 등의 숙박시설이 부족하여 관광객의 만족도를 떨어트릴 수 있기에
							새로운 호텔과 레저시설을 건설하고 기존 시설의 수리와 보수를 지속적으로 실시하기. <br><br>
							 </h5>
		...
		<div class="row my-4">
			...
			<div class="col-lg-4 col-md-6">
				...
				<div
					...
					<br>
					<span style="font-size: 200%; color : #344767;">&nbsp&nbsp&nbsp업종별 신용카드 소비액</span><span style="font-size: 100%;">(단위:1,000원)</span>
					<script type="text/javascript"
						src="https://www.gstatic.com/charts/loader.js"></script>
