...
<body>
    ...
    <div class="a">
        		<form action="map">
        			<button id="back" onclick="history.back()" style="position : absolute; right : 1420px;">이전 페이지</button>
      ...
      <div class="row">
        <div class="col-12" style= "width:650px; height:95%;">
          <div class="card mb-4">
            ...
            <div>
                <h2 id="all"> &nbsp;<%=request.getSession().getAttribute("area")%>의 <%=loc %> 리스트</h2>
            </div>
            <br>
            <div>
                ...
                <%for (int i = 0; i < 10; i++)  {%>
	                <li class="loc" id="li_<%=i %>" style="font-size: 25px;"><b><%=i+1 %>. <%=fList.get(i).getTravel_spot_name() %></b>
	                        <ul type="square" style="font-size: 17px;">
	                            <li class="loc_add"><%=fList.get(i).getTravel_spot_addr() %></li>
	                        </ul>
	                </li>
                <%} %>
                <%} else if (loc.equals("지역 맛집")) {%>
                 <%for (int i = 0; i < 10; i++)  {%>
	                <li class="loc" id="li_<%=i %>" style="font-size: 25px;"><b><%=i+1 %>. <%=rList.get(i).getRestaurant_name() %></b>
	                        <ul type="square" style="font-size: 17px;">
	                            <li class="loc_add"><%=rList.get(i).getRestaurant_addr() %></li>
	                        </ul>
	                </li>
                	<%} %>
                 <%} %>
