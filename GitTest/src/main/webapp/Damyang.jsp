					...
					<div class="card-body p-3">
						<div class="row">
							<div class="col-lg-6">
								...
								<br>
									<h3 class="font-weight-bolder">맛있는 음식과 특산물이 풍부한<br> 
									미식의 도시</h3>
									<br>
									<h5>
									담양은 대한민국 전라남도 남부에 위치한 지방 관광 도시. <br>
									미식의 도시라는 명칭에 걸맞게 식음료업의 비중이 약 87%로 <br>
									압도적으로 높다. <br>
									대한민국에서 가장 넓은 계곡으로 유명한 담양계곡이 있으며, <br>
									또한 대나무숲으로 유명한 죽녹원과 한밭의 수려함을 자랑하는 <br>
									담양호가 있다.<br>
									담양은 멋있는 관광지와 맛있는 음식으로 가족들(약 60%)과 <br>
									많이 방문한다. 
									</h5>
								</div>
							</div>
							<div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
								...
								<div
									...
									<img class="w-100 position-relative z-index-2 pt-4"
										src="./assets/img/damyang_img.jpg" alt="rocket">
								</div>
							</div>
			...
			<div class="col-lg-5">
				<div class="card h-100 p-3">
					<div
						...
						style="background-image: url('./assets/img/daenamu.jpg');">
						<span class="mask bg-gradient-suggest"></span>
						<div
							class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
							<h3 class="text-white font-weight-bolder mb-4 pt-2">제안방향</h3>
							<h5 style="color: white;">1. 담양 관광지 활용 <br>
							죽녹원, 메타프로방스, 메타세쿼이아 가로수길 등 담양의 대표 관광지 또한 매우 예쁘지만,
						    사람들의 관심을 끌만한 컨텐츠가 부족하기 때문에 재미있는 컨텐츠를 만들어 사람들의 시선을 끌어보기. <br> <br>
							2. 담양 축제 활용 <br>
							2019년 이후 코로나로 인해 진행되지 못했던 전남 담양 대나무 축제가 
							4년만에 2023년부터 다시 개최되므로 적극적으로 지역 축제를 활용하기. <br><br>
							3.담양 유기농체험농장<br> 
							담양에서 유기농 농장 체험을 할 수 있는 곳으로, 직접 농사를 짓고 수확하는 체험을 할 수 있으며, 담양에서 채취한 산나물을 이용한 요리 체험도 가능.
							</h5>
						</div>
					</div>
				</div>
