							...
							<div class="col-lg-6">
								<div class="d-flex flex-column h-100">
									...
									<h5>
													...
													외국인 관광객 수가 꾸준히 증가 하고 있었으나 최근 코로나19 대유행으로 하락세를 띄고 있다.<br>
													<br>
									</h5>
								</div>
							</div>
					...
					<div
						...
						<div
							...
							<h5 style = "color :white;">1. 편향된 관광객 문제 해결<br>
							 여름철에 집중되어 있는 방문객의 분산을 위해 여러 계절에 맞는 다양한 관광 프로그램을 마련하고,
							 주로 인기 있는 관광지(여수밤바다, 오동도, 고소리 마을 등)외에도 조용한 곳을 소개하여 분산을 유도하기.<br>
