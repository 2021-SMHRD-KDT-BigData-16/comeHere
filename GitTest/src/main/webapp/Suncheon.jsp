...
<body class="g-sidenav-show  bg-gray-100">
	...
	<main
		...
		<div class="container-fluid py-1 px-3">
			<h3 align="center">자연의 도시</h3>
			<h1 align="center">순천</h1>
			<br>
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="d-flex flex-column h-100">
									...
									<br>
									<h5>대한민국 내 최초로 도시재생 사업을 추진하여 도심 지역의 문화 유산을 보존하고,
									교통체증 문제를 해결하는 등 도시환경 개선에 많은 노력을 기울이고 있는 자연에 특화되어있다.<br>
				                    매력적인 측면이 많아 다양한 즐길 거리가 있어 방문객들에게 좋은 기억을 남기는 도시이다.</h5>
								</div>
							</div>
				...
				<div class="card h-100 p-3">
					<div
						...
						<div
							...
							순천만습지나 순천만국가정원 등의 관광자원을 적극적으로 활용하기.
							관광객이 자연과 함께 즐길 수 있는 체험 프로그램, 생태여행 등의 새로운 관광상품을 개발하기.<br>
							<br>
						    2.지역 문화자원을 활용하기<br>
                            낙안읍성민속마을, 선암사, 송광사등 전통문화와 역사유산이 풍부한 지역.
                            이러한 문화자원을 활용해 지역특색 있는 문화체험 프로그램, 전통공예 체험, 역사유적 관광 등의 새로운 관광상품을 개발하기.<br>
                            </h5>
						</div>
					</div>
			</div>
