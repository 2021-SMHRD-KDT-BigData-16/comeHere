						...
						<div class="row">
							<div class="col-lg-6">
								...
								<br>
									...
									미식의 도시라는 명칭에 걸맞게 식음료업(약 87%)의 비중이 압도적으로 높음. <br>
									대한민국에서 가장 넓은 계곡으로 유명한 담양계곡이 있으며, 또한 대나무숲으로 유명한 죽녹원과
									한밭의 수려함을 자랑하는 담양호가 있음.<br>
									담양은 멋있는 관광지와 맛있는 음식으로 가족들(약 60%)과 많이 방문함. 
									</h5>
								</div>
							</div>
				...
				<div class="card h-100 p-3">
					<div
						...
						<div
						    ...
						    사람들의 관심을 끌만한 &nbsp;컨텐츠가 부족하기 때문에 재미있는 컨텐츠를 만들어 사람들의 시선을 끌어보는 것이 좋을 것 같음. <br> <br>
							2. 담양 축제 활용 <br>
							2019 개최 이후 4년만에 코로나로 인해 진행되지 못했던 전남 담양 대나무 축제가 
							2023년부터는 다시 개최되므로 앞으로 축제를 활용하는 것이 좋을 것 같음. <br><br>
							3.담양 유기농체험농장<br> 
							담양에서 유기농 농장 체험을 할 수 있는 곳으로, 직접 농사를 짓고 수확하는 체험을 할 수 있으며, <br> 
							담양에서 채취한 산나물을 이용한 요리 체험도 가능.
							</h5>
						</div>
					</div>
				</div>
