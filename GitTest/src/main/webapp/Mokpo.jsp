						...
						<div class="row">
							<div class="col-lg-6">
								<div class="d-flex flex-column h-100">
									...
									<br>
									<h5>
										목포는 아름다운 바다 경관을 자랑하지만 다른 볼거리도 많은 매력적인 도시. <br> 
										근대역사관을 통해 근대 역사의 아픔을 간접적으로 체험 할 수 있으며,
										영화 1987의 촬영지로 잘 알려진
										시화골목에 가면 70~80년대 거리의 풍경을 그대로 느낄 수 있다.<br> 
										또한 해양문화 축제가 열리는 평화광장에 가면 젊은이들의 활기가 느껴지고, 
										9시가 되면 폭죽과 함께 춤추는 바다분수의 아름관경을 볼 수 있다.
										</h5>
				...
				<div class="card h-100 p-3">
					<div
						...
						<div
							...
							2. 과거를 느낄수 있는 다양한 공간 <br>
							근대역사관을 통해 일제시대의 아픔과, 영화 1987 촬영지인 시화골목등을 적극 활용하여 관광객들이 과거를 느낄수 있는 테마를 조성.  <br><br>
