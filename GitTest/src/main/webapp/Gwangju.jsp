						...
						<div class="row">
							<div class="col-lg-6">
								<div class="d-flex flex-column h-100">
									...
									<h5>광주는 역사적으로도 중요한 도시로, 한국 독립운동의 중심지 중 하나. 특히 5.18 민주화 운동은 광주에서 시작되어 전국적인 운동으로 확대되었다.<br>
									예술과 문화의 중심지로, 국내 최대규모의 문화예술 축제인 광주비엔날레와 국내 최초의 현대미술 전문 박물관인 광주시립미술관 등 다양한 예술과 문화 시설이 있다. <br>
									월드뮤직페스티벌, 영화제 등 많은 축제와 전시회, 공연등이 열리고 있다.<br>
									역사와 문화, 경제, 자연환경 등 다양한 면에서 매력적인 도시로, 국내외 많은 사람들이 찾는 곳이다.<br>
									<!--문화 예술의 도시임에도 불구하고 문화예술분야의 언급량이 낮음(다른 카테고리 대비 언급량)--></h5>					
								</div>
							</div>
			...
			<div class="col-lg-5">
				<div class="card h-100 p-3">
					<div
						...
						style="background-image: url('./assets/img/mudeung.jpg');">
						<span class="mask bg-gradient-suggest"></span>
						<div
							class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
							<h3 class="text-white font-weight-bolder mb-4 pt-2">제안 방향
							</h3>
							<h5 style="color: white;">1. 인프라 확충<br>
 							 일부 축제장은 인프라가 부족해 관람객들의 편의성을 높일 수 있는 시설이 부족한 경우가 <br>
							 있어서, 축제장 인근에 주차장, 음식점, 화장실 등 편의시설을 개선하고 확충함으로써 <br>
							 관람객들의 편의성을 높이기<br><br>
							
							2. 참여도 부족 <br>
							지역주민들이 적극적으로 참여할 수 있도록 문화예술 프로그램, 체험형 프로그램, <br>
							푸드트럭 축제 등 다양한 프로그램을 제공하기<br>
							</h5>
						</div>
					</div>
				</div>
